...
public partial class Level
{
    ...
    /// <summary>
    /// King-of-the-hill objective tile — hub with positioned terminal placements. Default 3
    /// outgoing connections.
    /// </summary>
    public ZoneNode GenKingOfTheHillGeomorph(ZoneNode node, BuildDirector director, int maxConnections = 3)
    {
        var zone = Planner.GetZone(node)!;
        zone.GenKingOfTheHillGeomorph(this, director);
