...
public partial record WardenObjective
{
    ...
    private void Build_ReactorStartup(BuildDirector director, Level level)
    {
        ...
        FindLocationInfo = new Text("Gather information about the location of the Reactor");
        ...
        InZoneFindItem = new Text("Find the reactor control panel and initiate the startup");
        SolveItem = new Text("Make sure the Reactor is fully started before leaving");
    ...
    private void PostBuildIntel_ReactorStartup(Level level)
    {
        ...
        if (ReactorStartupGetCodes)
        {
            level.ElevatorDropWardenIntel.Add((Generator.Between(1, 10), Generator.Draw(new List<string>
            {
                ...
                ">... Someone has to leave the room!\r\n>... <size=200%><color=red>We can't spare anyone!</color></size>\r\n>... I'll run it.",
                ">... Three hold, one runs.\r\n>... That's the plan.\r\n>... <size=200%><color=red>It's a terrible plan!</color></size>",
                ">... Don't you leave us!\r\n>... <size=200%><color=red>No choice! Code's not on the HUD!</color></size>\r\n>... [running footsteps]",
                ">... Two doors, three of us!\r\n>... <size=200%><color=red>Somebody cover the ramp!</color></size>\r\n>... [gunfire]",
                ">... Who's fastest?\r\n>... <size=200%><color=red>Then go! Right now!</color></size>\r\n>... [running footsteps]",
                ">... <size=200%><color=red>Keep your light off!</color></size>\r\n>... [breathing] It's pitch black out here.\r\n>... They'll see me.",
                ">... Keep talking to me.\r\n>... <size=200%><color=red>Something's walking behind me!</color></size>\r\n>... [whispering]",
                ">... Out of glowsticks. Running blind.\r\n>... Hallway's full of them.\r\n>... <size=200%><color=red>I can hear them breathing!</color></size>",
                ">... Miles of dark between me and you.\r\n>... <size=200%><color=red>Nobody's coming if I go down!</color></size>\r\n>... Just get the log.",
                ">... [whispering] Sleepers all through this corridor.\r\n>... <size=200%><color=red>I can't crawl past all of them!</color></size>\r\n>... Go slow.",
                $">... [panting] Got it! Got it!\r\n>... \"{verifyCode}\"!\r\n>... <size=200%><color=red>Now get me out of here!</color></size>",
                ">... PING it!\r\n>... <size=200%><color=red>Terminal's two rooms over!</color></size>\r\n>... Moving!",
                ">... LIST shows nothing here.\r\n>... Wrong terminal!\r\n>... <size=200%><color=red>Try the next one!</color></size>",
                ">... [typing] LIST LOGS...\r\n>... <size=200%><color=red>It's empty! Nothing on it!</color></size>\r\n>... Wrong room!",
                $">... READ it! READ the log!\r\n>... Four letters...\r\n>... <size=200%><color=red>It says \"{verifyCode}\"!</color></size>",
                ">... Three terminals in this room!\r\n>... <size=200%><color=red>Which one has the log?!</color></size>\r\n>... [frantic typing]",
                ">... <size=200%><color=red>This terminal's dead!</color></size>\r\n>... No power in the whole room.\r\n>... [static]",
                $">... Log file's open!\r\n>... <size=200%><color=red>Four letters! \"{verifyCode}\"!</color></size>\r\n>... Copy!",
                ">... Log's half garbage!\r\n>... Letters keep dropping out!\r\n>... <size=200%><color=red>I can't read it!</color></size>",
                ">... <size=200%><color=red>What's the code?! What's the code?!</color></size>\r\n>... Slower! Say it slower!\r\n>... [static]",
                $">... Spell it out!\r\n>... <size=200%><color=red>\"{verifyCode}\"! You copy?!</color></size>\r\n>... Copy!",
                ">... You're breaking up!\r\n>... <size=200%><color=red>Repeat the code!</color></size>\r\n>... [static crackling]",
                $">... Code's coming through!\r\n>... \"{verifyCode}\"!\r\n>... <size=200%><color=red>Type it! Type it now!</color></size>",
                ">... I called it twice!\r\n>... <size=200%><color=red>Nobody's on the terminal!</color></size>\r\n>... They're all fighting!",
                ">... Say the letters!\r\n>... <size=200%><color=red>I can't hear you over the guns!</color></size>\r\n>... [gunfire]",
                $">... That's not what I said!\r\n>... It's \"{verifyCode}\"!\r\n>... <size=200%><color=red>Retype it!</color></size>",
                $">... [static] ...ode is... \"{verifyCode}\"...\r\n>... <size=200%><color=red>Say again! Say again!</color></size>\r\n>... [static crackling]",
                ">... Timer's bleeding out!\r\n>... <size=200%><color=red>Twenty seconds and he's not back!</color></size>\r\n>... [frantic typing]",
                ">... Nine... eight...\r\n>... <size=200%><color=red>Where is he?!</color></size>\r\n>... [static]",
                ">... Window's closing!\r\n>... He's still way out there!\r\n>... <size=200%><color=red>We're not making it!</color></size>",
                ">... <size=200%><color=red>Timer hit zero!</color></size>\r\n>... Whole wave for nothing.\r\n>... [groaning]",
                ">... [static] ...heard him scream out there.\r\n>... <size=200%><color=red>Nobody goes after him!</color></size>\r\n>... Hold the reactor!",
                $">... Log's filed under a dead man's name.\r\n>... <size=200%><color=red>Code's \"{verifyCode}\"!</color></size>\r\n>... Copy that!",
                $">... How long have I got?!\r\n>... Not long enough!\r\n>... <size=200%><color=red>\"{verifyCode}\"! Take it! Take it!</color></size>",
                $">... REACTOR_VERIFY's pre-typed!\r\n>... Just need the letters!\r\n>... <size=200%><color=red>\"{verifyCode}\"! Go!</color></size>",
                ">... Command rejected!\r\n>... <size=200%><color=red>That's the wrong code!</color></size>\r\n>... Read it again!",
                $">... REACTOR_VERIFY {verifyCode}. Entered.\r\n>... <size=200%><color=red>Next wave already!</color></size>\r\n>... [alarm blaring]",
                ">... Get off the terminal, let me type!\r\n>... [frantic typing]\r\n>... <size=200%><color=red>I keep mistyping it!</color></size>",
                $">... Hands won't stop shaking.\r\n>... <size=200%><color=red>Say it one more time!</color></size>\r\n>... \"{verifyCode}\"!",
                ">... <size=200%><color=red>They're through the door!</color></size>\r\n>... We're down a man!\r\n>... [gunfire]",
                ">... Can't hold both sides!\r\n>... <size=200%><color=red>Where's our fourth?!</color></size>\r\n>... Getting the code!",
                ">... Giant on the ramp!\r\n>... We're three!\r\n>... <size=200%><color=red>We can't stop it!</color></size>",
                ">... They're in the reactor room!\r\n>... <size=200%><color=red>Get him back up!</color></size>\r\n>... [screaming]",
                ">... Sentry's dry!\r\n>... <size=200%><color=red>Nothing's covering the stairs!</color></size>\r\n>... [gunfire intensifies]",
                $">... I'm too far out to make it back!\r\n>... Code's \"{verifyCode}\"!\r\n>... <size=200%><color=red>Type it without me!</color></size>",
                ">... Two of us still standing.\r\n>... <size=200%><color=red>Wave's not even half done!</color></size>\r\n>... [panting]",
                ">... Door's sealed on my route!\r\n>... <size=200%><color=red>Going the long way around!</color></size>\r\n>... There's no time for that!",
                ">... <size=200%><color=red>There's a blood door in my way!</color></size>\r\n>... I can't open that alone!\r\n>... [growling]",
                ">... Scout's sitting right on the door.\r\n>... <size=200%><color=red>It won't move!</color></size>\r\n>... [whispering] Waiting...",
                ">... Fog's over my head out here!\r\n>... <size=200%><color=red>I'm swimming in it!</color></size>\r\n>... [coughing]",
                ">... <size=200%><color=red>Runner, respond!</color></size>\r\n>... He's not answering.\r\n>... [static]",
                ">... His comm cut off mid-word.\r\n>... <size=200%><color=red>He had the code!</color></size>\r\n>... [static crackling]",
                ">... Got one letter out of him. Then nothing.\r\n>... <size=200%><color=red>Someone else has to go!</color></size>\r\n>... [breathing heavily]",
            }))!);
        }
