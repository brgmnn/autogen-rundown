...
public static class TerminalUplink
{
    ...
    public static string[] FourLetterWords => new[]
    {
        ...
        "busy", "cage", "cake", "call", "camp", "card", "care", "case", "cash", "cast",
        "cave", "cell", "chef", "chew", "chip", "city", "clan", "clap", "claw", "clay",
        "clip", "club", "clue", "coal", "coat", "code", "coin", "cold", "coma", "comb",
        "cone", "cook", "cool", "copy", "core", "corn", "cost", "cozy", "crab", "crew",
        "crop", "crow", "cube", "cuff", "cure", "cute", "damp", "dare", "dark", "dart",
        "dash", "data", "date", "dawn", "dead", "deal", "deck", "deed", "deep", "dent",
        "deny", "desk", "dial", "diet", "dime", "dine", "dire", "dirt", "dish", "diva",
        "dive", "does", "doll", "done", "doom", "door", "dose", "down", "drag", "draw",
        "drip", "drop", "drug", "drum", "dual", "duck", "duel", "duet", "dull", "dump",
        "dune", "dunk", "dust", "duty", "earn", "ease", "east", "easy", "echo", "edge",
        "edit", "eery", "else", "envy", "epic", "etch", "ever", "evil", "exam", "exit",
        "expo", "face", "fact", "fade", "fail", "fake", "fall", "fame", "fang", "farm",
        "fast", "fate", "fear", "feed", "feel", "feet", "fill", "film", "find", "fine",
        "fire", "firm", "fish", "fist", "fits", "five", "flag", "flak", "flap", "flat",
        "flaw", "flew", "flex", "flip", "flop", "flow", "flux", "foam", "foil", "folk",
        "food", "fool", "foot", "fork", "form", "fort", "foul", "frat", "free",
        "frog", "fuel", "full", "fund", "funk", "fury", "fuzz", "gain", "game", "gang",
        "gasp", "gate", "gaze", "gear", "germ", "girl", "give", "glow", "goal", "goat",
        "gold", "golf", "gone", "good", "grab", "grid", "grin", "grip", "grow", "gulf",
        "guru", "hack", "half", "hall", "halo", "hard", "hawk", "head", "hear", "heat",
        "hell", "help", "herd", "here", "hero", "hide", "hill", "hint", "hire",
        "hiss", "hive", "hoax", "hold", "hole", "holy", "home", "hood", "hook", "hope",
        "horn", "host", "hour", "huge", "hulk", "hunt", "hurl", "hurt", "husk", "hymn",
        "hype", "idea", "idle", "idly", "idol", "iffy", "inch", "iris", "iron", "itch",
        "item", "jack", "jail", "jaws", "jazz", "jeep", "jobs", "join", "joke",
        "jolt", "jump", "junk", "jury", "just", "keep", "kick", "kill", "kilo", "kind",
        "king", "kiss", "kite", "kiwi", "knee", "knob", "know", "lack", "lady", "lair",
        "lake", "lama", "lamb", "lamp", "land", "lane", "lard", "lash", "last",
        "lawn", "lazy", "lead", "leaf", "lean", "leap", "left", "lend", "lens", "less",
        "levy", "liar", "life", "lift", "like", "lily", "limb", "lime", "line", "link",
        "lint", "lips", "list", "live", "load", "loaf", "loan", "lock", "logo", "long",
        "look", "loop", "loot", "lord", "lore", "lose", "loss", "lost", "love", "luck",
        "lump", "lush", "lynx", "made", "mail", "main", "make", "mark", "mask", "mass",
        "mate", "math", "maze", "meal", "mean", "menu", "mesh", "mess", "mild", "mile",
        "milk", "mini", "mint", "miss", "mist", "mojo", "monk", "mono", "mood", "moon",
        "more", "most", "moth", "move", "much", "mule", "muse", "must", "mute", "nail",
        "name", "navy", "near", "neat", "neck", "need", "neon", "nest", "news", "next",
        "nice", "nine", "none", "noon", "nose", "nosy", "note", "noun", "nuke", "numb",
        "oboe", "odds", "oily", "omen", "omit", "once", "only", "open", "oval", "oven",
        "over", "pack", "page", "paid", "park", "pass", "past", "path", "pawn", "peak",
        "peel", "pelt", "perk", "pest", "pick", "pipe", "plan", "play", "plot", "plug",
        "plum", "poem", "poke", "pole", "pony", "pool", "pope", "pork", "port", "pose",
        "post", "prop", "puck", "pull", "pulp", "puma", "pump", "punk", "pure", "push",
        "quit", "quiz", "race", "raft", "rage", "raid", "rail", "rain", "ramp", "rank",
        "rant", "rare", "rash", "rate", "rear", "redo", "rely", "rent", "rest", "rice",
        "rich", "ride", "riff", "rift", "ring", "riot", "ripe", "rise", "risk", "road",
        "roar", "robe", "rock", "roof", "room", "rope", "rose", "rosy", "rude", "ruin",
        "rule", "runt", "ruse", "rush", "rust", "safe", "salt", "same", "sand", "sane",
        "save", "scan", "scar", "seal", "seed", "seen", "sell", "semi", "send", "shoe",
        "shop", "shot", "show", "sick", "side", "sift", "sign", "silk", "sing", "sink",
        "site", "size", "skin", "skip", "skit", "slam", "slap", "slay", "slim", "slip",
        "slot", "slow", "slug", "snag", "snap", "snip", "snow", "snug", "soak",
        "soap", "sock", "soda", "sofa", "soft", "sold", "some", "song", "soon", "sort",
        "soul", "soup", "sour", "spam", "span", "spin", "spit", "spot", "spur", "stab",
        "star", "stay", "stem", "step", "stew", "stir", "stun", "such", "suit", "sure",
        "swan", "swim", "taco", "take", "tale", "talk", "tall", "tame", "tank", "task",
        "taxi", "tear", "teen", "tell", "tend", "tent", "term", "test", "text", "that",
        "them", "then", "they", "thin", "this", "tick", "tide", "tidy", "tier", "ties",
        "tile", "tilt", "time", "tire", "toad", "told", "toll", "tone", "took", "tool",
        "torn", "town", "trap", "tree", "trim", "trio", "trip", "true", "tsar", "tuba",
        "tube", "tuna", "tune", "turn", "twig", "twin", "type", "ugly", "undo", "unit",
        "urge", "used", "user", "vase", "vast", "verb", "very", "vest", "vibe", "vice",
        "view", "vine", "visa", "void", "volt", "vote", "wage", "wait", "wake", "walk",
        "wall", "want", "warm", "warp", "wart", "wash", "wasp", "wave", "weak",
        "week", "were", "west", "when", "whip", "wife", "wild", "will", "wind", "wine",
        "wing", "wire", "wise", "wolf", "wood", "wool", "word", "work", "worm",
    ...
    public static string[] FiveLetterWords => new[]
    {
        ...
        "boles", "books", "boons", "boots", "borne", "bough", "braid", "brake",
        ...
        "damps", "dance", "dared", "dares", "dates", "daubs", "dears", "death",
        ...
        "knelt", "knits", "knobs", "knots", "known", "label", "ladle", "lambs",
        ...
        "lulls", "lunar", "lurid", "lymph", "lyric", "mains", "maize", "major",
        ...
        "opens", "opera", "ounce", "ovals", "owner", "oxide", "paler", "pales",
        "palsy", "panel", "panic", "pared", "party", "paste", "patio", "paved",
        ...
        "pours", "press", "pries", "prime", "privy", "prize", "props", "prosy",
        "prove", "prows", "proxy", "psalm", "puffy", "pumps", "puree", "purge",
        ...
        "skull", "slack", "slang", "sleds", "sleek", "sleet", "slept", "slime",
        ...
        "years", "yield", "yoked", "yolks", "young", "yours"
    };
    ...
    public static string[] SixLetterWords => new[]
    {
        ...
        "ghetto", "shroud", "rapper", "quiver", "sprays", "imbued", "booboo",
        ...
        "nearby", "janice", "pearly", "sudden", "venial", "rebels", "blonde",
        ...
        "aisles", "juggle", "lapels", "silage", "mutant", "avocet", "flamed",
        ...
        "sedges", "highly", "parlay", "rubber", "valets", "rueful", "modest",
        ...
        "fogged", "tiptoe", "embeds", "rained", "shaper", "freely", "groves",
        "yeoman", "dances", "stifle", "zigzag", "native", "zeroes", "knocks",
        "sculls", "driver", "equine", "jingle", "zeroth", "dilate", "darner", "abbess",
        "curing", "agenda", "revolt", "clowns", "origin", "scarfs", "bluest", "chords",
        "heresy", "merest", "darned", "babine", "clipse", "rhymes", "metals",
        ...
        "bombed", "hyphen", "bevels", "steers", "unhook", "albums", "backup",
        ...
        "relate", "husker", "mussel", "baobab", "cuboid", "binder", "sugars",
        "schist", "obsess", "obtuse", "unless", "morrow", "recoup", "prefer", "prover",
        "anemia", "plaint", "riprap", "busses", "critic", "howled", "sanity", "member",
        "ripper", "guilds", "satyrs", "rookie", "corals", "speers", "leaves",
        "smudge", "payees", "musher", "ranged", "duster", "woolly", "canner",
        ...
        "moiety", "echoes", "wetted", "regime", "hummus", "vertex", "puzzle",
        ...
        "ketone", "cougar", "partly", "gather", "inodes", "gunman", "inning",
        ...
        "resign", "wiggle", "engulf", "yogurt", "discus", "galore", "steels",
        ...
        "eschew", "revues", "bowman", "rushed", "grovel", "baring", "robles",
        ...
        "unseat", "cupids", "slalom", "malted", "hermit", "deltas", "bogeys",
        ...
        "kaftan", "busboy", "mouton", "pumper", "bowled", "feline", "veiled",
        ...
        "imager", "slough", "rebind", "broths", "eights", "skills", "pundit",
        ...
        "remove", "batten", "ravers", "typify", "stitch", "roused", "shades",
        "grouts", "parens", "bidden", "parish", "fiddle", "gunmen", "homers",
        ...
        "rabies", "swifty", "preyed", "puppet", "limpid", "inking", "beaver",
        ...
        "flings", "craves", "hominy", "mortar", "tiptop", "trader", "urbane",
    ...
    public static string[] SevenLetterWords => new[]
    {
        ...
        "bashful", "bathtub", "battles", "baubles", "beading", "bearish",
        ...
        "bracing", "brasher", "braving", "breaded", "breathy", "breezes",
        ...
        "comedic", "comment", "commune", "company", "compare", "compels",
        ...
        "foaming", "focuser", "folders", "fooling", "footers", "footway",
        ...
        "gelatin", "general", "genetic", "gestalt", "gigabit", "giraffe",
        ...
        "panacea", "pancake", "paneled", "panning", "papayas", "parable",
        ...
        "precise", "pregame", "preheat", "premise", "prepare", "present",
        ...
        "puzzled", "pyramid", "quality", "quantal", "quarrel", "quickly",
